...
\begin{enumerate}
	...
	The rules retrieved were also the same as the ones retrieved by the stored procedure. 
	\begin{figure}[H]
		\centering
		\captionsetup{justification=centering}
